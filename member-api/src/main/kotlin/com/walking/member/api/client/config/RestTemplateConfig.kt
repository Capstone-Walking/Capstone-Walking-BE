...
import com.walking.member.api.client.config.interceptor.LogClientHttpRequestInterceptor
import com.walking.member.api.client.config.interceptor.RetryPolicyClientHttpRequestInterceptor
...
class RestTemplateConfig(
    ...
    private val logClientHttpRequestInterceptor: LogClientHttpRequestInterceptor
) {
    @Bean
    fun restTemplate(
